...
install_nginx_modsecurity(){
  ...
  cd nginx-1.15.0/
  ./configure --user=www-data --group=www-data --with-pcre-jit --with-debug --with-http_ssl_module --add-module=/root/JShielder/UbuntuServer_16.04LTS/src/ModSecurity/nginx/modsecurity
  make
  make install
